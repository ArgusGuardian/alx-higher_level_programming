#!/usr/bin/python3
"""Defines unittests for every function in base module"""
import os
import unittest
...
class TestBase_instantiation(unittest.TestCase):
    ...
    def test_no_arg(self):
        ex1 = Base()
        ex2 = Base()
        self.assertEqual(ex1.id, ex2.id - 1)

    def test_three_bases(self):
        ex1 = Base()
        ex2 = Base()
        b3 = Base()
        self.assertEqual(ex1.id, b3.id - 2)
    ...
    def test_nb_instances_after_unique_id(self):
        ...
        ex2 = Base(12)
        b3 = Base()
        self.assertEqual(ex1.id, b3.id - 1)
...
class TestBase_to_json_string(unittest.TestCase):
    ...
    def test_to_json_string_rectangle_type(self):
        ...
        self.assertEqual(
            str, type(Base.to_json_string([rect.to_dictionary()])))
...
class TestBase_from_json_string(unittest.TestCase):
    ...
    def test_from_json_string_one_rectangle(self):
        ...
        json_input = Rectangle.to_json_string(input)
        list_output = Rectangle.from_json_string(json_input)
        self.assertEqual(input, list_output)
...
class TestBase_load_from_file(unittest.TestCase):
    ...
    def test_load_from_file_first_rectangle(self):
        ...
        self.assertEqual(str(rect1), str(list_rect_output[0]))
    ...
    def test_load_from_file_second_rectangle(self):
        ...
        Rectangle.save_to_file([rect1, rect2])
        list_rect_output = Rectangle.load_from_file()
        self.assertEqual(str(rect2), str(list_rect_output[1]))
...
class TestBase_save_to_file_csv(unittest.TestCase):
    ...
    def test_save_to_file_csv_two_rectangles(self):
        ...
        Rectangle.save_to_file_csv([rect1, r2])
        with open("Rectangle.csv", "r") as f:
...
class TestBase_load_from_file_csv(unittest.TestCase):
    ...
    def test_load_from_file_csv_first_square(self):
        ...
        list_sq_output = Square.load_from_file_csv()
        self.assertEqual(str(sq1), str(list_sq_output[0]))
    ...
    def test_load_from_file_csv_second_square(self):
        ...
        Square.save_to_file_csv([sq1, sq2])
        list_sq_output = Square.load_from_file_csv()
        self.assertEqual(str(sq2), str(list_sq_output[1]))
