#!/usr/bin/python3
"""Defines unittests for square module"""
import io
import sys
import unittest
...
class TestSquare_size(unittest.TestCase):
    """Unittests for testing size init"""
...
class TestSquare_x(unittest.TestCase):
    """Unittests for testing init square x attribute"""
...
class TestSquare_y(unittest.TestCase):
    """Unittests for testing initi of square y attribute"""
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """Unittests for testing order of attributes in square"""
...
class TestSquare_area(unittest.TestCase):
    """Unittests for testing the area method in square class"""
